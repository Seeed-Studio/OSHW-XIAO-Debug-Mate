...
<p align="center">
  <a href="https://www.seeedstudio.com/Seeed-Studio-XIAO-Debug-Mate-p-6588.html">
    <img src="https://img.shields.io/badge/🛒_Seeed_Studio-Buy_Now-green?style=for-the-badge" alt="Buy at Seeed Studio">
  </a>
  <a href="https://www.aliexpress.com/item/1005010448361665.html">
    <img src="https://img.shields.io/badge/🛒_AliExpress-Buy_Now-orange?style=for-the-badge" alt="Buy at AliExpress">
  </a>
...
- 🛒 [**Buy at Seeed Studio**](https://www.seeedstudio.com/Seeed-Studio-XIAO-Debug-Mate-p-6588.html)
- 🛒 [**Buy at AliExpress**](https://www.aliexpress.com/item/1005010448361665.html)
...
## 🙏 Acknowledgments
This product started with a simple GitHub discussion back in July 2024, where one of our XIAO Core users [rei-vilo opened Discussion #20 in our XIAO Open Roadmap](https://github.com/orgs/Seeed-Studio/discussions/20) with an observation that resonated with many developers: “A programmer-debugger probe is a very useful and ‘must have’ tool for embedded system development. Today, there is no affordable offer.” Then we started the journey of creating this device together with many other community members who contributed a lot of input. Thank you to everyone who contributed ideas and feedback throughout this journey. A special big shout-out to [rei-vilo](https://github.com/rei-vilo), [Chris](https://github.com/CWGwaltney), PJ, Hendra, Ernesto, [Benjamin](https://github.com/kartben), [Pete](https://github.com/petejohanson), NitekryDPaul for insightful feedback during v0.1 testing.
